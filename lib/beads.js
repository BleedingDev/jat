 ...
 * @property {Dependency[]} [dependents] - Alias for blocked_by (tasks this task blocks)
 ...
 * @returns {{projects?: Record<string, { path?: string }> }|null} JAT config or null
 */
  ...
  for (const project of projects) {
    ...
    try {
      ...
      for (const task of /** @type {any[]} */ (tasks)) {
        ...
        // Back-compat alias: "dependents" = tasks this task blocks (blocked_by)
        task.dependents = task.blocked_by;
