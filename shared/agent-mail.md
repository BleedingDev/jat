...
1) Same repository
   ...
   - Reserve files before you edit: `am-reserve "src/**/*.ts" --agent AgentName --ttl 3600 --exclusive --reason "bd-123"`
   - Communicate with threads: `am-send "Subject" "Body" --from Agent1 --to Agent2 --thread bd-123`
...
2) Across different repos in one project (e.g., Next.js frontend + FastAPI backend)
   ...
   - Use shared `thread_id` (e.g., ticket key like "bd-123") across repos for clean communication
