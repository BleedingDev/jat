<script lang="ts">
	...
	import { openTaskDrawer, openTaskDetailDrawer, openProjectDrawer, isSpawnModalOpen } from '$lib/stores/drawerStore';
				...
				>
					...
					<div class="border-t" style="border-color: oklch(0.30 0.02 250);">
						<button
							...
							onmouseleave={(e) => e.currentTarget.style.background = 'transparent'}
							onclick={() => { showSessionDropdown = false; openProjectDrawer(); }}
						>
							<svg class="w-3 h-3 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
				...
				>
					...
					<div class="border-t" style="border-color: oklch(0.30 0.02 250);">
						<button
							...
							onmouseenter={(e) => e.currentTarget.style.background = 'oklch(0.28 0.02 250)'}
							onmouseleave={(e) => e.currentTarget.style.background = 'transparent'}
							onclick={() => { showTaskDropdown = false; openProjectDrawer(); }}
						>
							<svg class="w-3 h-3 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
								<path stroke-linecap="round" stroke-linejoin="round" d="M12 4v16m8-8H4" />
							</svg>
