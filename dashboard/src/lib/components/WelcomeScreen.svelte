				...
				<div class="px-6 pb-6 space-y-4" style="border-top: 1px solid oklch(0.25 0.02 250);">
					...
					>
						...
						<div class="text-sm" style="color: oklch(0.75 0.10 85);">
							<strong>Tip:</strong> The dashboard automatically discovers any project in <code class="px-1 rounded" style="background: oklch(0.25 0.02 250);">~/code/</code> that has a <code class="px-1 rounded" style="background: oklch(0.25 0.02 250);">.beads/</code> directory.
						</div>
					</div>
				</div>
			{/if}
